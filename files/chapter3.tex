...
\shellcmd{iptables -t nat -l PREROUTING -d 150.217.5.123 -j DNAT --to-destination 192.168.1.12}
...
\shellcmd{iptables -t nat -l POSTROUTING -s 192.168.1.12 -j SNAT --to-source 150.217.5.123}
