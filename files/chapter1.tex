...
\begin{itemize}
	...
	\item Passo D. Tecnology Architecture, devo riuscire a fare l'information e l'architecture che mi sono prefissato di rispettare negli step precedenti -> Problema dei Requisiti
\end{itemize}
...
\textbf{\textit{Oss.}} Stiamo paralndo degli EAF perchè se so muovermi con questi concetti, allora so muovermi anche nella sicurezza di reti. Infatti, per tutta la security, ho continui requirements che la rete deve rispettare.
