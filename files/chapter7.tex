...
Per la QoS servono differenti strategie nelle diverse parti di rete. In particolare possiamo parlare di QoS nei nodi di rete e QoS end-to-end. La prima è sostanzialmente a livello IP: shaping del traffico, scheduling dei pacchetti, classificazione, riservazione delle risorse, etc. La seconda può coinvolgere anche i livelli protocollari superiori con meccanismi di  di segnalazione end-to-end, architetture di rete per la QoS, etc.
