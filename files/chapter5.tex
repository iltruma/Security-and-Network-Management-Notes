...
\item IP Spoofing:
	\begin{enumerate} 
   	 ...
   	 \item \textit{Smurf:} l'attaccante fa lo spoofing dell'IP dellla vittima e comincia a mandare pacchetti ICMP Echo Reply causando un DoS alla vittima (DoS 			 				type).
   	 \end{enumerate}
